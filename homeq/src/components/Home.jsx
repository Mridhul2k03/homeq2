...
const Home = () => {
  return (
    ...
    <section className='flex justify-center items-center  gap-4 flex-wrap py-10'>
        <div className='sm:w-2/5 md:w-1/5 border-[1px] border-black p-4 py-8 w-[90%] flex justify-center transition-all duration-500 ease-out hover:translate-y-[-8px] hover:border-red-500 hover:bg-red-500 hover:text-white ' >
